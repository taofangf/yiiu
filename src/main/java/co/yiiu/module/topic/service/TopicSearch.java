...
public class TopicSearch {
    ...
    public Page<Topic> search(int p, int size, String text) {
        ...
        org.hibernate.search.jpa.FullTextQuery jpaQuery = fullTextEntityManager.createFullTextQuery(query, Topic.class);
        ...
        for (Topic _topic : data) {
            ...
            for (String fieldName : fields) {
                ...
                Object fieldValue = ReflectionUtils.invokeMethod(
                        BeanUtils.getPropertyDescriptor(Topic.class, fieldName).getReadMethod(), _topic);
                ...
                if (hightLightFieldValue != null) {
                    ReflectionUtils.invokeMethod(
                            BeanUtils.getPropertyDescriptor(Topic.class, fieldName).getWriteMethod(), newTopic,
