    ...
    <div class="row">
        ...
        <div class="col-md-10">
            <div class="row" style="margin: 0 -5px;">
                <div class="col-md-9">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <a href="/">主页</a> / 板块列表
                            <span class="pull-right"><a href="/admin/node/add?pid=${pid!}">添加板块</a></span>
                        </div>
                            ...
                            <table class="table table-striped">
                                ...
                                <#list nodes as node>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/admin/node/${node.id!}/edit"
              ...
              <a href="javascript:if(confirm('确定要校正各个板块的话题数吗？')) location.href='/admin/node/correction'">
                校正话题数
              </a>
            </span>
                        </div>
