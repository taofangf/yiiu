                ...
                <div class="panel-body">
                    <form action="/admin/node/${node.id!}/edit" method="post" id="nodeForm">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" id="name" value="${node.name!}" placeholder="名称"
                                   class="form-control">
                        </div>
                        <div class="form-group">
                            <label for="value">值</label>
                            <input type="text" name="value" id="value" value="${node.value!}" placeholder="值"
                                   class="form-control">
                        </div>
                        <div class="form-group">
                            <label for="topicCount">话题数</label>
                            <input type="text" name="topicCount" id="topicCount" value="${node.topicCount!}"
                                   placeholder="话题数" class="form-control">
                        </div>
                        <div class="form-group">
                            <label for="intro">描述</label>
                            <textarea name="intro" id="intro" placeholder="描述，1000字以内"
                                      class="form-control">${node.intro!}</textarea>
                        </div>
